...
export default {
  ...
  methods: {
    ...
    getData () {
      ...
      this.$store.dispatch("findWardMaterialChargeNew", params).then(res => {
    ...
    print () {
      let params = 'PrintClient://病区材料消耗统计.grf,' + util.BaseURL + 'findWardMaterialChargeNew?hospitalId='
        + this.$store.state.userInfoObj.hospitalId + '&wardId=' + this.wardDeptId + '&startDate=' + this.timeId[0].format('yyyy-MM-dd 00:00:00') +
...
<style>
.hospital-material .ivu-table-wrapper {
