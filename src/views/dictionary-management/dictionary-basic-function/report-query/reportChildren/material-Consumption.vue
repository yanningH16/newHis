...
export default {
  ...
  methods: {
    ...
    getData () {
      ...
      this.$store.dispatch("findMaterialConsumeByDept", params).then(res => {
    ...
    print () {
      let params = 'PrintClient://科室材料消耗统计(医技).grf,' + util.BaseURL + 'findMaterialConsumeByDept?hospitalId='
...
<style>
.material-Consumption .ivu-table-wrapper {
